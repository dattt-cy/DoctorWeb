...
export const DOCTOR_INFO: DoctorProfile = {
  ...
  photoAbout: "/images/bac-si.jpg",
  yearsExperience: 10,
  patientsCount: "Hàng nghìn",
  hospital: "Bệnh viện Phụ Sản – Nhi Đà Nẵng",
  degree: "Thạc sĩ Y khoa",
  email: "",
  phone: "0919.083.332",
  address: "522 Phạm Hùng, Hòa Xuân, Cẩm Lệ, Đà Nẵng",
  workingHours: {
    weekdays: "Thứ 2 – Thứ 6: 8:00 – 17:00",
    saturday: "Thứ 7: 8:00 – 12:00",
  },
  currentPositions: [
    "Bác sĩ – Bệnh viện Phụ Sản – Nhi Đà Nẵng (2022 – nay)",
    "Khám và tư vấn sức khỏe trẻ em tại 522 Phạm Hùng, Đà Nẵng",
    "Người sáng tạo nội dung về chăm sóc sức khỏe trẻ em",
  ],
  education: [
  ...
  socialLinks: {
    facebook: "https://www.facebook.com/bac.si.phuong.thao.902498",
    youtube: "#",
    zalo: "https://zalo.me/0919083332",
    tiktok: "#",
  },
};
